# Generated by Django 5.1.15 on 2026-08-31 08:44
            ...
            options={
                ...
                "permissions": [
                    ...
                    (
                        ...
                        "Can approve or reject a purchase order",
                    ),
                    ...
                    (
                        ...
                        "Can change company and financial configuration",
                    ),
                    (
                        "manage_chart_of_accounts",
                        "Can change the chart of accounts and mappings",
                    ),
                    ...
                    (
                        ...
                        "Can post a movement that takes stock negative",
                    ),
                    (
                        "override_duplicate_vendor_invoice",
                        "Can accept a duplicate vendor invoice number",
                    ),
                    (
                        "override_return_quantity",
                        "Can return more than the eligible quantity",
                    ),
                    (
                        "override_exchange_rate",
                        "Can override the exchange rate for a transaction",
                    ),
                ],
                "managed": False,
                "default_permissions": (),
