...
urlpatterns = [
    ...
    path("invoices/<int:pk>/submit/", views.SalesInvoiceSubmitView.as_view(), name="invoice_submit"),
    path("invoices/<int:pk>/post/", views.SalesInvoicePostView.as_view(), name="invoice_post"),
    path("invoices/<int:pk>/print/", views.SalesInvoicePrintView.as_view(), name="invoice_print"),
